export const en = {
  ...
  admin: {
    ...
    editCheatsheet: "Edit cheatsheet",
    newProject: "New project",
    editProject: "Edit project",
    newGlossary: "New term",
    editGlossary: "Edit term",
    fCategory: "Category",
    fTerm: "Term",
    fDefinition: "Definition (Markdown)",
    fLevel: "Level",
    fPosition: "Position",
    fStatement: "Statement (Markdown)",
    fSolution: "Reference solution (Markdown)",
    fPassThreshold: "Pass threshold (%)",
    fSteps: "Steps",
    fQuestions: "Questions",
    fItems: "Items",
    fTestCases: "Test cases",
    fPrompt: "Prompt",
    fType: "Type",
    fOptions: "Options",
    ...
    fInput: "Input",
    fExpected: "Expected output",
    fSample: "Sample test (shown to students)",
    fCorrect: "Correct",
    addStep: "Add step",
