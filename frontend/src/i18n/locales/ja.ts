...
export const ja: Resources = {
  ...
  admin: {
    ...
    newTrack: "新しいトラック",
    editTrack: "トラックを編集",
    newCheatsheet: "新しいチートシート",
    editCheatsheet: "チートシートを編集",
    ...
    fCategory: "カテゴリ",
    fTerm: "用語",
    fDefinition: "定義 (Markdown)",
    fLevel: "レベル",
    fPosition: "位置",
    fStatement: "問題文 (Markdown)",
    fSolution: "模範解答 (Markdown)",
    fPassThreshold: "合格しきい値 (%)",
    fSteps: "ステップ",
    fQuestions: "問題",
    fItems: "項目",
    fTestCases: "テストケース",
